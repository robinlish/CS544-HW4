...
plot(0:6, striking_c, type="h",xaxt = "n",
     xlab="Times of striking out",ylab="PMF of striking out", ylim = c(0, 0.6),main="Probability distribution of striking out (p=70%)")
abline(h=0)
...
plot(0:6, striking_d, type="h",xaxt = "n",
     xlab="Times of striking out",ylab="PMF of striking out", ylim = c(0, 0.6),main="Probability distribution of striking out (p=30%)")
abline(h=0)
...
#When the striking-out probability is 50%, the PMF is symmetric.
#Thus,the probability of getting 3 times of striking out for the next 6 batters is the highest, 
#and the probabilities of getting 0 or 6 times of striking out for the next 6 batters are equally the lowest.

#When the striking-out probability is 70%, the PMF is left-skewed. 
#Thus, the probability of getting 4 times of striking out for the next 6 batters is the highest, 
#and the probability of getting 0 times of striking out for the next 6 batters is the lowest.

#When the striking-out probability is 30%, the PMF is right-skewed. 
#Thus, the probability of getting 2 times of striking out for the next 6 batters is the highest, 
